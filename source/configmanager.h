...
* Initial : Maxime Chevalier-Boisvert on February 4, 2009
****************************************************************
Revisions and bug fixes: added very_verbose option by Daniele
Cono D'Elia, August 2015.
*/
class ConfigManager
{
public:
	...
	// Very verbose output mode config variable
	static ConfigVar s_veryVerboseVar;
