...
ConfigVar JITCompiler::s_jitEnableVar("jit_enable", ConfigVar::BOOL, "true"); /* DCD: JIT now enabled by default */
...
llvm::Function* JITCompiler::getLLVMFunctionToCall(llvm::Function* functionToCall, llvm::Module* currentModule) {
    ...
    if (F->getParent() != currentModule) {
        /* Function has been defined in a different module. Let's check whether
...
llvm::FunctionPassManager* JITCompiler::generateFPM(llvm::Module* M) {
    ...
    // FPM->add(llvm::createCondPropagationPass()); /* DCD: already commented in the original code */
...
void JITCompiler::initialize()
{
    ...
    s_JITHelper = new MCJITHelper("mcvm", s_Context, ConfigManager::s_verboseVar);

    s_pExecEngine = s_JITHelper->ExecEngine;
    s_data_layout = const_cast<llvm::DataLayout*>(s_JITHelper->ExecEngine->getDataLayout());
    llvm::Module* initModule = s_JITHelper->lastModule;
	...
	regNativeFunc("JITCompiler::callExceptHandler", (void*)JITCompiler::callExceptHandler, llvm::Type::getVoidTy(*s_Context), LLVMTypeVector(4, VOID_PTR_TYPE), initModule);

	// Register basic interpreter functions
	regNativeFunc("getBoolValue", (void*)getBoolValue, llvm::Type::getInt8Ty(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("getInt64Value", (void*)getInt64Value, llvm::Type::getInt64Ty(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("getFloat64Value", (void*)getFloat64Value, llvm::Type::getDoubleTy(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("DataObject::convertType", (void*)DataObject::convertType, VOID_PTR_TYPE, convertArgs, initModule);
	regNativeFunc("ArrayObj::create", (void*)ArrayObj::create, VOID_PTR_TYPE, LLVMTypeVector(1, getIntType(sizeof(size_t))), initModule);
	regNativeFunc("ArrayObj::addObject", (void*)ArrayObj::addObject, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("ArrayObj::append", (void*)ArrayObj::append, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("ArrayObj::getArrayObj", (void*)ArrayObj::getArrayObj, VOID_PTR_TYPE, getObjArgs, initModule);
	regNativeFunc("ArrayObj::getArraySize", (void*)ArrayObj::getArraySize, getIntType(sizeof(size_t)), LLVMTypeVector(1, VOID_PTR_TYPE), initModule);
	regNativeFunc("Environment::bind", (void*)Environment::bind, VOID_PTR_TYPE, LLVMTypeVector(3, VOID_PTR_TYPE), initModule);
	regNativeFunc("Environment::lookup", (void*)Environment::lookup, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Environment::extend", (void*)Environment::extend, VOID_PTR_TYPE, LLVMTypeVector(1, VOID_PTR_TYPE), initModule);
	regNativeFunc("ProgFunction::setLocalEnv", (void*)ProgFunction::setLocalEnv, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("ProgFunction::getLocalEnv", (void*)ProgFunction::getLocalEnv, VOID_PTR_TYPE, LLVMTypeVector(1, VOID_PTR_TYPE), initModule);
	regNativeFunc("RunError::throwError", (void*)RunError::throwError, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::callFunction", (void*)Interpreter::callFunction, VOID_PTR_TYPE, callFnArgs, initModule);
	regNativeFunc("Interpreter::execStatement", (void*)Interpreter::execStatement, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("Interpreter::evalAssignStmt", (void*)Interpreter::evalAssignStmt, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("Interpreter::assignObject", (void*)Interpreter::assignObject, llvm::Type::getVoidTy(*s_Context), assignArgs, initModule);
	regNativeFunc("Interpreter::evalExprStmt", (void*)Interpreter::evalExprStmt, llvm::Type::getVoidTy(*s_Context), evalArgs, initModule);
	regNativeFunc("Interpreter::evalExpression", (void*)Interpreter::evalExpression, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::evalSymbolExpr", (void*)Interpreter::evalSymbolExpr, VOID_PTR_TYPE, evalParamArgs, initModule);
	regNativeFunc("Interpreter::evalSymbol", (void*)Interpreter::evalSymbol, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::evalUnaryExpr", (void*)Interpreter::evalUnaryExpr, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::evalBinaryExpr", (void*)Interpreter::evalBinaryExpr, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::evalCellArrayExpr", (void*)Interpreter::evalCellArrayExpr, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("Interpreter::evalParamExpr", (void*)Interpreter::evalParamExpr, VOID_PTR_TYPE, evalParamArgs, initModule);
	regNativeFunc("Interpreter::evalCellIndexExpr", (void*)Interpreter::evalCellIndexExpr, VOID_PTR_TYPE, evalArgs, initModule);

	// Register matrix utility functions
	regNativeFunc("DataObject::copyObject", (void*)DataObject::copyObject, VOID_PTR_TYPE, LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("BaseMatrixObj::getDimCount", (void*)BaseMatrixObj::getDimCount, getIntType(sizeof(size_t)), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, true, true);
	regNativeFunc("BaseMatrixObj::getSizeArray", (void*)BaseMatrixObj::getSizeArray, llvm::PointerType::getUnqual(getIntType(sizeof(size_t))), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, true, true);
	regNativeFunc("BaseMatrixObj::expandMatrix", (void*)BaseMatrixObj::expandMatrix, llvm::Type::getVoidTy(*s_Context), expandArgs, initModule);
	regNativeFunc("MatrixF64Obj::makeScalar", (void*)MatrixF64Obj::makeScalar, VOID_PTR_TYPE, LLVMTypeVector(1, llvm::Type::getDoubleTy(*s_Context)), initModule);
	regNativeFunc("CharArrayObj::makeScalar", (void*)CharArrayObj::makeScalar, VOID_PTR_TYPE, LLVMTypeVector(1, llvm::Type::getInt8Ty(*s_Context)), initModule);
	regNativeFunc("LogicalArrayObj::makeScalar", (void*)LogicalArrayObj::makeScalar, VOID_PTR_TYPE, LLVMTypeVector(1, llvm::Type::getInt8Ty(*s_Context)), initModule);
	regNativeFunc("MatrixF64Obj::getScalarVal", (void*)MatrixF64Obj::getScalarVal, llvm::Type::getDoubleTy(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("CharArrayObj::getScalarVal", (void*)CharArrayObj::getScalarVal, llvm::Type::getInt8Ty(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("LogicalArrayObj::getScalarVal", (void*)LogicalArrayObj::getScalarVal, llvm::Type::getInt8Ty(*s_Context), LLVMTypeVector(1, VOID_PTR_TYPE), initModule, true, false, true);
	regNativeFunc("MatrixF64Obj::readElem1D", (void*)(MatrixF64Obj::MATRIX_1D_READ_FUNC)MatrixF64Obj::readElem1D, llvm::Type::getDoubleTy(*s_Context), read1DArgs, initModule);
	regNativeFunc("MatrixF64Obj::readElem2D", (void*)(MatrixF64Obj::MATRIX_2D_READ_FUNC)MatrixF64Obj::readElem2D, llvm::Type::getDoubleTy(*s_Context), read2DArgs, initModule);
	regNativeFunc("MatrixF64Obj::writeElem1D", (void*)(MatrixF64Obj::MATRIX_1D_WRITE_FUNC)MatrixF64Obj::writeElem1D, llvm::Type::getVoidTy(*s_Context), f64Write1DArgs, initModule);
	regNativeFunc("MatrixF64Obj::writeElem2D", (void*)(MatrixF64Obj::MATRIX_2D_WRITE_FUNC)MatrixF64Obj::writeElem2D, llvm::Type::getVoidTy(*s_Context), f64Write2DArgs, initModule);
	regNativeFunc("CharArrayObj::readElem1D", (void*)(CharArrayObj::MATRIX_1D_READ_FUNC)CharArrayObj::readElem1D, llvm::Type::getInt8Ty(*s_Context), read1DArgs, initModule);
	regNativeFunc("CharArrayObj::readElem2D", (void*)(CharArrayObj::MATRIX_2D_READ_FUNC)CharArrayObj::readElem2D, llvm::Type::getInt8Ty(*s_Context), read2DArgs, initModule);
	regNativeFunc("CharArrayObj::writeElem1D", (void*)(CharArrayObj::MATRIX_1D_WRITE_FUNC)CharArrayObj::writeElem1D, llvm::Type::getVoidTy(*s_Context), i8Write1DArgs, initModule);
	regNativeFunc("CharArrayObj::writeElem2D", (void*)(CharArrayObj::MATRIX_2D_WRITE_FUNC)CharArrayObj::writeElem2D, llvm::Type::getVoidTy(*s_Context), i8Write2DArgs, initModule);
	regNativeFunc("LogicalArrayObj::readElem1D", (void*)(LogicalArrayObj::MATRIX_1D_READ_FUNC)LogicalArrayObj::readElem1D, llvm::Type::getInt8Ty(*s_Context), read1DArgs, initModule);
	regNativeFunc("LogicalArrayObj::readElem2D", (void*)(LogicalArrayObj::MATRIX_2D_READ_FUNC)LogicalArrayObj::readElem2D, llvm::Type::getInt8Ty(*s_Context), read2DArgs, initModule);
	regNativeFunc("LogicalArrayObj::writeElem1D", (void*)(LogicalArrayObj::MATRIX_1D_WRITE_FUNC)LogicalArrayObj::writeElem1D, llvm::Type::getVoidTy(*s_Context), i8Write1DArgs, initModule);
	regNativeFunc("LogicalArrayObj::writeElem2D", (void*)(LogicalArrayObj::MATRIX_2D_WRITE_FUNC)LogicalArrayObj::writeElem2D, llvm::Type::getVoidTy(*s_Context), i8Write2DArgs, initModule);

	// Register addition operation (+) functions
	regNativeFunc("MatrixF64Obj::binArrayOp<AddOp>", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::binArrayOp<AddOp<float64>, float64>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::scalarArrayOp<AddOp>", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::lhsScalarArrayOp<AddOp<float64>, float64, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<AddOp>", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::binArrayOp<AddOp<Complex128>, Complex128>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::scalarArrayOp<AddOp>", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::lhsScalarArrayOp<AddOp<Complex128>, Complex128, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("arrayArithOp<AddOp>", (void*)(MATRIX_BINOP_FUNC)arrayArithOp<AddOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("scalarArithOp<AddOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarArithOp<AddOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register subtraction (-) operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<SubOp>", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::binArrayOp<SubOp<float64>, float64>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<SubOp>", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::lhsScalarArrayOp<SubOp<float64>, float64, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::rhsScalarArrayOp<SubOp>", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::rhsScalarArrayOp<SubOp<float64>, float64, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<SubOp>", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::binArrayOp<SubOp<Complex128>, Complex128>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<SubOp>", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::lhsScalarArrayOp<SubOp<Complex128>, Complex128, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::rhsScalarArrayOp<SubOp>", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::rhsScalarArrayOp<SubOp<Complex128>, Complex128, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("arrayArithOp<SubOp>", (void*)(MATRIX_BINOP_FUNC)arrayArithOp<SubOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarArithOp<SubOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarArithOp<SubOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("rhsScalarArithOp<SubOp>", (void*)(SCALAR_BINOP_FUNC)rhsScalarArithOp<SubOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register multiplication (*) and array multiplication (.*) operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<MultOp>", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::binArrayOp<MultOp<float64>, float64>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::scalarMult", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::scalarMult<float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::matrixMult", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::matrixMult, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<MultOp>", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::binArrayOp<MultOp<Complex128>, Complex128>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::scalarMult", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::scalarMult<float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::matrixMult", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::matrixMult, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("arrayArithOp<MultOp>", (void*)(MATRIX_BINOP_FUNC)arrayArithOp<MultOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("scalarMultOp", (void*)(SCALAR_BINOP_FUNC)scalarMultOp, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixMultOp", (void*)(MATRIX_BINOP_FUNC)matrixMultOp, VOID_PTR_TYPE, evalArgs, initModule);

	// Register division (/) and array-division (./) operation functions
	regNativeFunc("DivOp<float64>::op", (void*)DivOp<float64>::op, llvm::Type::getDoubleTy(*s_Context), f64BinOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::binArrayOp<DivOp>", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::binArrayOp<DivOp<float64>, float64>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<DivOp>", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::lhsScalarArrayOp<DivOp<float64>, float64, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::rhsScalarArrayOp<DivOp>", (void*)(MatrixF64Obj::F64_SCALAR_BINOP_FUNC)MatrixF64Obj::rhsScalarArrayOp<DivOp<float64>, float64, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::matrixRightDiv", (void*)(MatrixF64Obj::MATRIX_BINOP_FUNC)MatrixF64Obj::matrixRightDiv, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<DivOp>", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::binArrayOp<DivOp<Complex128>, Complex128>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<DivOp>", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::lhsScalarArrayOp<DivOp<Complex128>, Complex128, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::rhsScalarArrayOp<DivOp>", (void*)(MatrixC128Obj::F64_SCALAR_BINOP_FUNC)MatrixC128Obj::rhsScalarArrayOp<DivOp<Complex128>, Complex128, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::matrixRightDiv", (void*)(MatrixC128Obj::MATRIX_BINOP_FUNC)MatrixC128Obj::matrixRightDiv, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("arrayArithOp<DivOp>", (void*)(MATRIX_BINOP_FUNC)arrayArithOp<DivOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarArithOp<DivOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarArithOp<DivOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("rhsScalarArithOp<DivOp>", (void*)(SCALAR_BINOP_FUNC)rhsScalarArithOp<DivOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixRightDivOp", (void*)(MATRIX_BINOP_FUNC)matrixRightDivOp, VOID_PTR_TYPE, evalArgs, initModule);

	// Register the array-OR (|) operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<OrOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<OrOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::scalarArrayOp<OrOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<OrOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::MatrixC128Obj::binArrayOp<OrOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<OrOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	...
	regNativeFunc("MatrixF64Obj::binArrayOp<AndOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<AndOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::scalarArrayOp<AndOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<AndOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::MatrixC128Obj::binArrayOp<AndOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<AndOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::scalarArrayOp<AndOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<AndOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("LogicalArrayObj::binArrayOp<AndOp>", (void*)(LogicalArrayObj::MATRIX_LOGIC_OP_FUNC)LogicalArrayObj::binArrayOp<AndOp<bool>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("LogicalArrayObj::scalarArrayOp<AndOp>", (void*)(LogicalArrayObj::F64_SCALAR_LOGIC_OP_FUNC)LogicalArrayObj::lhsScalarArrayOp<AndOp<bool>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<AndOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<AndOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::scalarArrayOp<AndOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<AndOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<AndOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<AndOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("scalarLogicOp<AndOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<AndOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register equality (==) comparison operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<EqualOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<EqualOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::scalarArrayOp<EqualOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<EqualOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixF64Obj::MatrixC128Obj::binArrayOp<EqualOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<EqualOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::scalarArrayOp<EqualOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<EqualOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("LogicalArrayObj::binArrayOp<EqualOp>", (void*)(LogicalArrayObj::MATRIX_LOGIC_OP_FUNC)LogicalArrayObj::binArrayOp<EqualOp<bool>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("LogicalArrayObj::scalarArrayOp<EqualOp>", (void*)(LogicalArrayObj::F64_SCALAR_LOGIC_OP_FUNC)LogicalArrayObj::lhsScalarArrayOp<EqualOp<bool>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<EqualOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<EqualOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::scalarArrayOp<EqualOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<EqualOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<EqualOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<EqualOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("scalarLogicOp<EqualOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<EqualOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register greater-than (>) comparison operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<GreaterThanOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<GreaterThanOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<GreaterThanOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<GreaterThanOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<GreaterThanOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<GreaterThanOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<GreaterThanOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<GreaterThanOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<GreaterThanOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<GreaterThanOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::lhsScalarArrayOp<GreaterThanOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<GreaterThanOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<GreaterThanOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<GreaterThanOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarLogicOp<GreaterThanOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<GreaterThanOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register less-than (<) comparison operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<LessThanOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<LessThanOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<LessThanOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<LessThanOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<LessThanOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<LessThanOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<LessThanOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<LessThanOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<LessThanOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<LessThanOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::lhsScalarArrayOp<LessThanOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<LessThanOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<LessThanOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<LessThanOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarLogicOp<LessThanOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<LessThanOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register greater-than-or-equal (>=) comparison operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<GreaterThanEqOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<GreaterThanEqOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<GreaterThanEqOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<GreaterThanEqOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<GreaterThanEqOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<GreaterThanEqOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<GreaterThanEqOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<GreaterThanEqOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<GreaterThanEqOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<GreaterThanEqOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::lhsScalarArrayOp<GreaterThanEqOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<GreaterThanEqOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<GreaterThanEqOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<GreaterThanEqOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarLogicOp<GreaterThanEqOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<GreaterThanEqOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);

	// Register less-than-or-equal (<=) comparison operation functions
	regNativeFunc("MatrixF64Obj::binArrayOp<LessThanEqOp>", (void*)(MatrixF64Obj::MATRIX_LOGIC_OP_FUNC)MatrixF64Obj::binArrayOp<LessThanEqOp<float64>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixF64Obj::lhsScalarArrayOp<LessThanEqOp>", (void*)(MatrixF64Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixF64Obj::lhsScalarArrayOp<LessThanEqOp<float64>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("MatrixC128Obj::binArrayOp<LessThanEqOp>", (void*)(MatrixC128Obj::MATRIX_LOGIC_OP_FUNC)MatrixC128Obj::binArrayOp<LessThanEqOp<Complex128>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("MatrixC128Obj::lhsScalarArrayOp<LessThanEqOp>", (void*)(MatrixC128Obj::F64_SCALAR_LOGIC_OP_FUNC)MatrixC128Obj::lhsScalarArrayOp<LessThanEqOp<Complex128>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("CharArrayObj::binArrayOp<LessThanEqOp>", (void*)(CharArrayObj::MATRIX_LOGIC_OP_FUNC)CharArrayObj::binArrayOp<LessThanEqOp<char>, bool>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("CharArrayObj::lhsScalarArrayOp<LessThanEqOp>", (void*)(CharArrayObj::F64_SCALAR_LOGIC_OP_FUNC)CharArrayObj::lhsScalarArrayOp<LessThanEqOp<char>, bool, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
	regNativeFunc("matrixLogicOp<LessThanEqOp>", (void*)(MATRIX_BINOP_FUNC)matrixLogicOp<LessThanEqOp>, VOID_PTR_TYPE, evalArgs, initModule);
	regNativeFunc("lhsScalarLogicOp<LessThanEqOp>", (void*)(SCALAR_BINOP_FUNC)lhsScalarLogicOp<LessThanEqOp, float64>, VOID_PTR_TYPE, f64ScalarOpArgs, initModule);
...
)
{
    ...
    /* DCD: Initial MCJITHelper integration */
    SAVE_MODULE_IN_USE();
    if (MCJITModule == nullptr) {
        MCJITModule = s_JITHelper->generateFreshModule();
    }
    SET_MODULE_IN_USE(MCJITModule);
    ...
    /* DCD: we can set the attributes before creating a global mapping */
...
#if LLVMREV < 243589
    /* DCD: addGlobalMapping is broken for MCJIT in LLVM <= 3.6.2
     * Source: https://llvm.org/bugs/show_bug.cgi?id=20656 */
    s_JITHelper->registerNativeFunction(nativeFunctionName, (void*)pFuncPtr);
#else // untested :-)
    // Add a global mapping in the execution engine for the function pointer
    s_pExecEngine->addGlobalMapping(pFuncObj, (void*)pFuncPtr);
#endif
...
)
{
	...
	regNativeFunc(
		...
		retType,
		inTypes,
                nullptr, /* DCD: No MCJIT module to use for now: generate one */
		noMemWrites,
		noMemAccess,
		noThrows
	);
...
void JITCompiler::compileFunction(ProgFunction* pFunction, const TypeSetString& argTypeStr, llvm::Module* MCJITModule)
{
	...
	std::cout << "Compiling function: \"" << pFunction->getFuncName() << "\"" << std::endl;
        ...
        /* DCD: initial MCJITHelper integration */
        SAVE_MODULE_IN_USE();
        bool moduleCreate = (MCJITModule == nullptr);
        if (moduleCreate) {
            MCJITModule = s_JITHelper->generateFreshModule();
        }
        SET_MODULE_IN_USE(MCJITModule);
...
)
{
	...
	// Call the compiled function
        llvm::Function* functionToCall = getLLVMFunctionToCall(version.pLLVMFunc, MCJITModule); // originally
	entryBuilder.CreateCall(functionToCall, fnCallArgs);
	...
	switch (pStatement->getStmtType())
	{
		...
		default:
		{
			...
			// Create a call to execute this statement
                        llvm::Function* functionToCall = getLLVMFunctionToCall(execStmtFunc.pLLVMFunc, s_MCJITModuleInUse);
			builder.CreateCall2(functionToCall, pStmtPtr, pEnvObject);
...
)
{
	...
	// Create a call to execute this statement
        llvm::Function* functionToCall = getLLVMFunctionToCall(execStmtFunc.pLLVMFunc, s_MCJITModuleInUse);
	builder.CreateCall2(functionToCall, pStmtPtr, pEnvArg);
...
)
{
	...
	if (calleeFunction.pProgFunc == pProgFunc)
	{
		...
		callArgs.push_back(pOutStructPtr);
                llvm::Function* functionToCall = getLLVMFunctionToCall(calleeVersion.pLLVMFunc, s_MCJITModuleInUse);
		currentBuilder.CreateCall(functionToCall, callArgs);
	}
	else
	{
...
)
{
	...
	llvm::CallInst* pValue = irBuilder.CreateCall(functionToCall, arguments);
