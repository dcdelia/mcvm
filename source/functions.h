...
public:
	...
	ProgFunction* copy() const;
        ...
        // Method to recursively copy this node using the current body
        ProgFunction* copyWithCurrentBody() const;
...
private:
	...
	size_t m_nextTempId;
        ...
        // Helper method to recursively copy this node
	ProgFunction* copyAux(bool copyCurrentBody) const;
};
