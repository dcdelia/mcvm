...
/***************************************************************
* Function: ProgFunction::copyAux()
* Purpose : Auxiliary method to copy this IIR node recursively
* Initial : Daniele Cono D'Elia on August 21, 2015
****************************************************************
Revisions and bug fixes:
*/
ProgFunction* ProgFunction::copyAux(bool copyCurrentBody) const {
	...
	ProgFunction* pNewFunc;

        if (copyCurrentBody) {
            pNewFunc =  new ProgFunction(
                            m_funcName,
                            inParams,
                            outParams,
                            nestedFuncs,
                            (StmtSequence*)m_pCurrentBody->copy(),
                            m_isScript,
                            m_isClosure
                        );
        } else {
...
{
    return copyAux(false);
}

/***************************************************************
* Function: ProgFunction::copyWithCurrentBody()
* Purpose : Recursively copy using the current body
* Initial : Daniele Cono D'Elia on August 21, 2015
****************************************************************
Revisions and bug fixes:
*/
ProgFunction* ProgFunction::copyWithCurrentBody() const {
    return copyAux(true);
}
